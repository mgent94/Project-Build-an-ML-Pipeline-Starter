...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, required=True, help="Input artifact to split")

    parser.add_argument(
        "--test_size", type=float, required=True, help="Size of the test split. Fraction of the dataset, or number of items"
    )
